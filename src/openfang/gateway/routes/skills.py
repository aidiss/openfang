...
@router.get("")
async def skills_list(request: Request, gateway: GatewayDep):
    """List available skills."""
    all_skills = list(gateway.deps.comms.skills.skills.values())
    eligible = gateway.deps.comms.skills.eligible_skills()
